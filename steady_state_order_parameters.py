...
os.makedirs("graphs/steady_state_order_parameters", exist_ok=True)
...
for dens in density:
    result = calculate_final_order_parameter(nc, max_step + 1, dens, step, rng_seed)
    mean = result["mean"]
    std = result["std"]
...
plt.title("Steady State order parameters (Mean ± Std Error)")
plt.savefig("graphs/steady_state_order_parameters/steady_state_order_parameters.jpg", dpi=600)
plt.close()
...
plt.title("Steady State order parameters (Mean ± Std Error)")
plt.savefig("graphs/steady_state_order_parameters/steady_state_order_parameters_2.jpg", dpi=600)
plt.close()
...
plt.ylabel("Variance")
plt.title("Variance of order parameters vs Density")
plt.legend()
plt.tight_layout()
plt.savefig("graphs/steady_state_order_parameters/steady_state_order_parameters_variance.jpg", dpi=600)
plt.close()
...
plt.xlabel("Density ρ")
plt.ylabel("Variance")
plt.title("Variance of order parameters (2) vs Density")
plt.legend()
plt.tight_layout()
plt.savefig("graphs/steady_state_order_parameters/steady_state_order_parameters_2_variance.jpg", dpi=600)
plt.close()
